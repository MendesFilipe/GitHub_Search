...
function RepositoryOrStarredDetail(props) {
    ...
    <div>
      <div className={'card my-2'}>
        <div className={'card-body'}>
          ...
          <h6>
            {repository.license ? <h6>{repository.license.name}</h6> : null}
          </h6>
          <div className={'d-flex'}>
            ...
            <div className={'px-3'}>
              <FontAwesomeIcon className={'rotate-icon'} icon={faShareAlt} />{' '}
              {repository.forks_count} Forks
            </div>
            {repository.language ? (
              <div>
                <FontAwesomeIcon icon={faCode} /> {repository.language}
              </div>
            ) : null}
          </div>
        </div>
...
export default RepositoryOrStarredDetail;
